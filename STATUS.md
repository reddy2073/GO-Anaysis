...
> Last updated: **2026-04-18 13:16:10** (America/Chicago)
...
```
   41.2%  [############------------------]
   14,300 / 34,700 chunks
  +581 chunks since last check  |  Est. completion: ~3.1d
```
...
| Court Verdicts (HuggingFace) | 893 | +581 | 2,000 | 44.6% `[######---------]` | ~4.1h |  |
